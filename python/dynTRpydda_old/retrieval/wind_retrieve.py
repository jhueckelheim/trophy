...
def obj_fun(z, prec, parameters):
    ...
    fhandle = J_function(z, parameters)
    ghandle = grad_J(z, parameters)
...
def get_dd_wind_field(Grids, u_init, v_init, w_init, points=None, vel_name=None,
                      ...
                      write_folder=None, precision_dict=None):
    if store_history:
    ...
    if filt_iterations > 0:
        ...
        while iterations < filt_iterations:
            ...
            #ret = FixedPrec.TR_fixed(winds,fun, 1.e-3, test_its, epsTR=1.e-5, verbose=True, max_memory=10, delta_init=delta_init)
            filt_max_it = 10
            ...
            #ret = DynPrec.DynTR(winds, fun, prec_vec, 1.e-3, test_its, epsTR=1.e-5, verbose=True, max_memory=max_memory, delta_init=delta_init)
